//الدالة دي هي اللي بتسمحلك تعمل اتصال (Client) بين مشروعك و قاعدة البيانات اللي على Supabase.=>create client
import { createClient } from "@supabase/supabase-js";

export const supabaseUrl = "https://yiahpfazdctqljzmmtzx.supabase.co";
